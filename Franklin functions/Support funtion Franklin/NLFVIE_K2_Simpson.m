function [ua_iter,tk_xj,cg_it] = NLFVIE_K2_Simpson(fx, dvkut,dfkut, n, iter,tol)
...
BdJx{1}=pinv(hi_x_new-dvkut_xt*(hi_x_new(2:n-1,:).*(tk_xj-tk_xj_new(1:n-2))')-dfkut_xt*(hi_x_new(2:n-1,:).*(tk_xj-tk_xj_new(1:n-2))'));
%% 主函数
for i=2:iter+1  
