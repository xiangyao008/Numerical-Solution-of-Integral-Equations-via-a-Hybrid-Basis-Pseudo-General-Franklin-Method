%% Haar Wavelet Method (S2) for NLFVIE
% 核心逻辑: 循环测速 + 全局误差收敛阶分析
...
% [预热] Warm-up
fprintf('正在进行预热运行...\n');
[~, ~, ~] = NLFVIE_HAAR_S2(fx, dvkut, dfkut, n, iter, tol);
...
for i = 1:num_runs
    ...
    % 求解细网格 (Fine Grid)
    [ua_iter1, tk_xj1, cg_it1] = NLFVIE_HAAR_S2(fx, dvkut, dfkut, n, iter, tol);
...
[ua_iter2, tk_xj2, cg_it2] = NLFVIE_HAAR_S2(fx, dvkut, dfkut, n/2, iter, tol);
