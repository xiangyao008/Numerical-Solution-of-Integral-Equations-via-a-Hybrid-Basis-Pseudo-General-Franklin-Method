...
% RF=@(x)exp(-x);
%% 求解n配置点的解和误差
[ua_iter1,tk_xj1,cg_it1]=NLVIE_HAAR_S1(fx,dkut, n, iter,tol);
pointwise_error1 = PE1_HOHWM(RF,ua_iter1(:,cg_it1),1024);
 %% 求解n/2配置点的解和误差
[ua_iter2,tk_xj2,cg_it2]=NLVIE_HAAR_S1(fx,dkut, n/2, iter,tol);
pointwise_error2 = PE1_HOHWM(RF,ua_iter2(:,cg_it2),1024);
